...
Mobile Verification Toolkit (MVT) ищет различные индикаторы компрометации (IOC), связанные с шпионским ПО, таким как Pegasus. Вот основные типы IOC, которые MVT может обнаруживать:
Основные индикаторы компрометации, которые ищет MVT
Файлы:
Хэш-суммы файлов, связанных с вредоносным ПО.
Неправильные или подозрительные файлы в системных директориях.
Системные изменения:
Изменения в конфигурации системы, такие как новые или измененные настройки.
Необычные процессы или службы, запущенные на устройстве.
Сетевые активности:
Подозрительные IP-адреса и домены, к которым подключается устройство.
Необычные запросы к DNS или сетевым ресурсам.
Логи и журналы:
Анализ логов на наличие аномалий или признаков вредоносной активности.
Учетные записи и их активность, которые могут указывать на компрометацию.
Метаданные приложений:
Информация о приложениях, установленных на устройстве, которые могут быть связаны с вредоносной деятельностью.
Сигнатуры уязвимостей:
Оценка наличия известных уязвимостей в установленном программном обеспечении.
Заключение
MVT использует эти индикаторы для проверки устройства на наличие следов шпионского ПО и других угроз
